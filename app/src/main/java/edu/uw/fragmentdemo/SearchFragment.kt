...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val btn = rootView.findViewById<Button>(R.id.btn_search);
        btn.setOnClickListener {view ->
            val term:String = rootView.findViewById<EditText>(R.id.txt_search).text.toString();
            listener!!.onSearchSubmitted(term);
        }
        return rootView;
    }
